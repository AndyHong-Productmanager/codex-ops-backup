...
description: >
  Produce a UGC unboxing where one visible creator opens or has just opened a
  package and the product reveal is the climax. Use when unboxing, haul,
  PR-drop, first-reaction, opening-the-box, or reveal intent is explicit.
  Missing product or duration is an intake gap. Do not use for reviews without
  an unboxing arc, try-ons, tutorials, product-only ads, SaaS walkthroughs,
  generic ads, scripts, or footage edits.
---
