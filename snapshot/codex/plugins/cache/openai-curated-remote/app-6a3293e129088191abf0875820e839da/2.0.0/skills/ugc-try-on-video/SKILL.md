...
description: >
  Produce a finished UGC try-on video where one visible creator wears and poses with a garment,
...
Parse product photo or URL, duration, attached creator photo or desired creator
...
If a creator photo is attached, import it with `media_upload_and_confirm` and
use that confirmed ID without re-asking or editing the photo.
